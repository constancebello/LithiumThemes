function renderBatteryPercent(height, percentage, charging, low, color) {
    ...
    if(halfHearts > 1) {
        ...
        fullHeartContext.fillRect(scale, scale, scale * 2, scale);
        fullHeartContext.fillRect(scale * 4, scale, scale * 3, scale);
        fullHeartContext.fillRect(scale, scale * 2, scale * 6, scale * 2);
        fullHeartContext.fillRect(scale * 2, scale * 4, scale * 4, scale);
        fullHeartContext.fillRect(scale * 3, scale * 5, scale * 2, scale);
    ...
    if(halfHearts % 2 == 1) {
        ...
        halfHeartContext.fillRect(scale, scale, scale * 2, scale);
        halfHeartContext.fillRect(scale, scale * 2, scale * 3, scale * 2);
        halfHeartContext.fillRect(scale * 2, scale * 4, scale * 2, scale);
        halfHeartContext.fillRect(scale * 3, scale * 5, scale, scale);
